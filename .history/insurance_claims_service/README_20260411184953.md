...
### Option 1: Automated Local Setup (Recommended for Development)
...
- ✅ Set up .env file
- ✅ Check for PostgreSQL/Redis
- ✅ Run database migrations
- ✅ Start the application

**After initial setup, use quick start:**
```bash
# macOS/Linux
./scripts/start.sh
...
### Option 3: Hybrid Setup (Docker for DB, Local Python)
